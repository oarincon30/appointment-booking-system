...
public record AppointmentDTO(
        ...
        @Schema(example = "María Pérez") String patientName,
        @Schema(example = "1") Long dentistId,
        @Schema(example = "Dr. José Pérez") String dentistName,
        ...
        @Schema(example = "2025-09-01T12:00:00Z") OffsetDateTime cancelledAt,
        @Schema(example = "PATIENT") String cancelledByType,
        @Schema(example = "1") Long cancelledByPatientId,
        @Schema(example = "Cancelado desde WhatsApp") String cancellationReason
) {}
